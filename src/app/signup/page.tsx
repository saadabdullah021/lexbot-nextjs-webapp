...
// import googleLogo from "../assets/_Google Logo Icon.png";
// import sideBG from "../assets/login_side_image.png";
...
const Register = () => {
  ...
  return (
    <>
      <Head>
        <title>Lexbot/signup</title>
        <meta
          name="description"
          content="Signup to Lexbot to access your account."
        />
      </Head>
      ...
      <div className="flex flex-col lg:flex-row h-screen">
        ...
        <div className="lg:w-1/2 flex items-center justify-start ml-0 lg:ml-12  bg-white">
          <div className="lg:max-w-lg w-full p-6 lg:p-8">
            ...
            <button className="w-full mt-6 border border-gray-400 flex items-center justify-center py-3 px-4 rounded-lg hover:bg-gray-100">
              <span className="mr-2">
                <Image
                  src="/assets/_Google Logo Icon.png"
                  alt="Google logo"
                  className="w-5 h-5"
                  height={20}
                  width={20}
        ...
        <div className="lg:w-1/2 min-h-screen relative hidden lg:flex items-center bg-custom-gradient  justify-end h-screen">
          <img
            src="/assets/login_side_image.png"
